...
var drawPentagon = function(radius,x,y,rotation,sides,color) {
  var angle = 360 / sides;
  beginShape();
  
  for (var a = rotation; a < 360+rotation; a += angle) {
...
var Logo = function() {
    ...
    drawPentagon(150, width/2, height/2, heptagon_a, sides, color(0, 0, 0));
    popMatrix();
    
    textSize(85);
    fill(192, 192, 192, text_i);
    textAlign(CENTER, CENTER);
    text("$CT", 150, 200);
    fill(233, 8, 8, text_i);
    text("F", 250, 200);
    
    fill(192, 192, 192, background_i);
    rect(200, 200, 600, 600);
    popMatrix();
};

var Logo_run = function() {
    sides += 0.05;
    if(sides >= 7) {
        sides = 7;
        text_i += 2;
